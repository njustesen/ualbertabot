...
ProductionServiceManager::ProductionServiceManager() 
...
void ProductionServiceManager::update() 
{
...
// on unit destroy
void ProductionServiceManager::onUnitDestroy(BWAPI::Unit unit)
{
...
void ProductionServiceManager::manageBuildOrderQueue() 
{
...
BWAPI::Unit ProductionServiceManager::getProducer(MetaType t, BWAPI::Position closestTo)
{
...
BWAPI::Unit ProductionServiceManager::getClosestUnitToPosition(const BWAPI::Unitset & units, BWAPI::Position closestTo)
{
    if (units.size() == 0)
    {
        return nullptr;
...
void ProductionServiceManager::create(BWAPI::Unit producer, BuildOrderItem & item) 
{
    if (!producer)
    {
        return;
...
bool ProductionServiceManager::canMakeNow(BWAPI::Unit producer, MetaType t)
{
...
bool ProductionServiceManager::detectBuildOrderDeadlock()
{
...
void ProductionServiceManager::predictWorkerMovement(const Building & b)
{
    if (b.isGasSteal)
    {
        return;
...
void ProductionServiceManager::performCommand(BWAPI::UnitCommandType t) 
{
...
BWAPI::Unit ProductionServiceManager::selectUnitOfType(BWAPI::UnitType type, BWAPI::Position closestTo) 
{
...
void ProductionServiceManager::drawProductionInformation(int x, int y)
{
...
ProductionServiceManager & ProductionServiceManager::Instance()
{
...
bool ProductionServiceManager::canPlanBuildOrderNow() const
{
